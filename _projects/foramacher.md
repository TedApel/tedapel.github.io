...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/gehlhaar_stepbystep.jpg" title="Gehlhaar Step by Step diagram" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/foramacher_maxpatch.jpg" title="Max/MSP patch for Step by Step recreation" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Max/MSP patch for Step by Step recreation
</div>

Pasapas extended this work to sixty-four speakers arranged in a hanging octagon, divided into eight groups of eight.
