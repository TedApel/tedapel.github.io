...
{% include figure.liquid path="assets/img/whiteout.jpg" title="Whiteout - paper loudspeaker with actuator" class="img-fluid rounded z-depth-1" caption="Whiteout, a sound installation - Ted Apel - Paper, actuator, sound" %}
