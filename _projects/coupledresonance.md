...
og_image: assets/img/concomitant5.jpg
date: 2024-06-01
importance: 1000
category: soundart
---
...
<div class="row row-cols-1 row-cols-md-3">
  {% assign sub_projects = site.projects | where_exp: "p", "p.category == 'coupledresonance' or p.parent == 'coupledresonance'" | sort: "importance" | reverse %}
